...
export function applyBaseFilters(cars, { source, brand, yearFrom, yearTo, showDealsOnly }) {
  let result = cars;
...
export function getBestDeals(cars) {
  return [...cars].sort((a, b) => b.score - a.score).slice(0, 5);
}
